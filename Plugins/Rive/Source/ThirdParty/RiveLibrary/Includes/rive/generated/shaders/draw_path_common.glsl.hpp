...
TEXTURE_R16F(PER_DRAW_BINDINGS_SET, ATLAS_TEXTURE_IDX, _EXPORTED_atlasTexture);
#endif
                     ...
                     float2 atlasTextureInverseSize TEXTURE_CONTEXT_DECL)
{
    ...
    half4 coverages = TEXTURE_GATHER(_EXPORTED_atlasTexture,
                                     atlasSampler,
                                     atlasQuadCenter,
                                               ...
                                               VERTEX_CONTEXT_DECL)
{
        ...
        vertexType == STROKE_VERTEX)
    {
            ...
            (tessDataBeforeJoin.w & (MIRRORED_CONTOUR_CONTOUR_FLAG | 0xffffu)))
        {
            ...
            tesDataAfterJoin = TEXEL_FETCH(_EXPORTED_tessVertexTexture,
