...
namespace gpu {
namespace glsl {
const char draw_clockwise_path[] = R"===(/*
 * Copyright 2023 Rive
 */
...
#ifdef _EXPORTED_BORROWED_COVERAGE_PREPASS
...
#ifdef _EXPORTED_BORROWED_COVERAGE_PREPASS
    if (_EXPORTED_BORROWED_COVERAGE_PREPASS)
    {
#ifdef _EXPORTED_DRAW_INTERIOR_TRIANGLES
        ...
        half fragCoverage;
#ifdef _EXPORTED_ENABLE_FEATHER
        if (_EXPORTED_ENABLE_FEATHER && is_feathered_fill(v_edgeDistance))
        {
